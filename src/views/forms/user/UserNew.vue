<template>
  ...
  <vx-card>
    <div class="vx-row mb-12">
      ...
      <div class="vx-col w-full">
        <vs-input type="password" v-validate="'required|min:5'" label-placeholder="Heslo" name="password" ref="password" icon-pack="feather"
            ...
            this.$store.dispatch('users/create', this.user)
              .then(() => {
                ...
                this.$vs.notify({
                  ...
                  text: `Uživatel "${this.user.full_name}" byl úspěšně vytvořen.`
                })
              })
              .catch(error => {
                this.$vs.loading.close()
