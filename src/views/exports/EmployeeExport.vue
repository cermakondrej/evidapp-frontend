            ...
            <div class="vx-row">
              ...
              <div class="vx-col md:w-1/2 w-full mt-4">
                <div class="mt-4">
                  ...
                  <flat-pickr class="w-full" :config="configdateTimePicker" v-model="workStart" name="start"
              ...
              <div class="vx-col md:w-1/2 w-full mt-4">
                <div class="mt-4">
                  ...
                  <flat-pickr class="w-full" :config="configdateTimePicker" v-model="workBreakStart" name="break_start"
                              icon-pack="feather" icon="icon-clock" icon-no-border/>
                  <span class="text-danger text-sm"
                        v-show="errors.has('break_end')">{{ errors.first('break_end') }}</span>
                </div>
              ...
              <div class="vx-col md:w-1/2 w-full mt-4">
                <div class="mt-4">
                  ...
                  <flat-pickr class="w-full" :config="configdateTimePicker" v-model="workEnd" name="end"
                              icon-pack="feather" icon="icon-clock" icon-no-border/>
                </div>
              </div>
              <div class="vx-col md:w-1/2 w-full mt-4">
                <div class="mt-4">
                  ...
                  <flat-pickr class="w-full" :config="configdateTimePicker" v-model="workBreakEnd" name="end"
